const config = {
    'greeting': {
        'slogan': 'Los Negocios de Autos Deportivos',
        'image': 'negocio_guitarras.jpg',
        'text_button': 'Comprar!'
    },
    'description': {
        'title': '¿Quienes somos?',
        'image': 'cherryline.jpg',
        'text_description': 'Somos los que venden los Autos Mas Chidos Deportivos del mundo.'
    },
    'catalog': {
        'title': 'Nuestras Modelos',
        'products': [
            {
                'title': 'Telecaster',
